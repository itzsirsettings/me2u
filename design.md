...
> **SUPERSEDED** — this document is stale (references the deleted `Icons8Icon.tsx` and pre-refresh brand colors). The active spec is `design_v2.md` (Me2U Design System). Kept for history only.
