...
const INJECTED_STYLES = `
  ...
  .text-card-silver-matte {
      ...
      transform: translateZ(0);
      filter:
          drop-shadow(0px 12px 24px rgba(64,64,64,0.8))
          drop-shadow(0px 4px 8px rgba(64,64,64,0.6));
  }

  .premium-depth-card {
      background: linear-gradient(145deg, var(--color-slate) 0%, var(--color-dark) 100%);
      box-shadow:
          0 40px 100px -20px rgba(64, 64, 64, 0.9),
          0 20px 40px -20px rgba(64, 64, 64, 0.8),
          inset 0 1px 2px rgba(255, 255, 255, 0.2),
          inset 0 -2px 4px rgba(64, 64, 64, 0.8);
  ...
  .iphone-bezel {
      ...
      box-shadow:
          ...
          0 40px 80px -15px rgba(64,64,64,0.9),
          0 15px 25px -5px rgba(64,64,64,0.7);
  ...
  .hardware-btn {
      ...
      box-shadow:
          -2px 0 5px rgba(64,64,64,0.8),
          inset -1px 0 1px rgba(255,255,255,0.15),
          inset 1px 0 2px rgba(64,64,64,0.8);
  ...
  .widget-depth {
      ...
      box-shadow:
          0 10px 20px rgba(64,64,64,0.3),
          inset 0 1px 1px rgba(255,255,255,0.05),
          inset 0 -1px 1px rgba(64,64,64,0.5);
  ...
  .floating-ui-badge {
      ...
      box-shadow:
          ...
          0 25px 50px -12px rgba(64, 64, 64, 0.8),
  ...
  .btn-modern-light {
      ...
      box-shadow: 0 0 0 1px rgba(64,64,64,0.05), 0 2px 4px rgba(64,64,64,0.1), 0 12px 24px -4px rgba(64,64,64,0.3), inset 0 1px 1px rgba(255,255,255,1), inset 0 -3px 6px rgba(64,64,64,0.06);
  }
  .btn-modern-light:hover {
      transform: translateY(-3px);
      box-shadow: 0 0 0 1px rgba(64,64,64,0.05), 0 6px 12px -2px rgba(64,64,64,0.15), 0 20px 32px -6px rgba(64,64,64,0.4), inset 0 1px 1px rgba(255,255,255,1), inset 0 -3px 6px rgba(64,64,64,0.06);
  }
  .btn-modern-light:active {
      ...
      box-shadow: 0 0 0 1px rgba(64,64,64,0.1), 0 1px 2px rgba(64,64,64,0.1), inset 0 3px 6px rgba(64,64,64,0.1), inset 0 0 0 1px rgba(64,64,64,0.02);
  }
  .btn-modern-dark {
      background: linear-gradient(180deg, var(--color-slate) 0%, var(--color-dark) 100%);
      color: var(--color-light);
      box-shadow: 0 0 0 1px rgba(255,255,255,0.1), 0 2px 4px rgba(64,64,64,0.6), 0 12px 24px -4px rgba(64,64,64,0.9), inset 0 1px 1px rgba(255,255,255,0.15), inset 0 -3px 6px rgba(64,64,64,0.8);
  }
  .btn-modern-dark:hover {
      transform: translateY(-3px);
      background: linear-gradient(180deg, color-mix(in srgb, var(--color-slate) 86%, var(--color-light)) 0%, var(--color-slate) 100%);
      box-shadow: 0 0 0 1px rgba(255,255,255,0.15), 0 6px 12px -2px rgba(64,64,64,0.7), 0 20px 32px -6px rgba(64,64,64,1), inset 0 1px 1px rgba(255,255,255,0.2), inset 0 -3px 6px rgba(64,64,64,0.8);
  }
  .btn-modern-dark:active {
      transform: translateY(1px);
      background: var(--color-dark);
      box-shadow: 0 0 0 1px rgba(255,255,255,0.05), inset 0 3px 8px rgba(64,64,64,0.9), inset 0 0 0 1px rgba(64,64,64,0.5);
  }
                ...
                >
                  ...
                  <div className="absolute inset-[7px] z-10 overflow-hidden rounded-[2.5rem] bg-navy text-snow shadow-[inset_0_0_15px_rgba(8,19,32,1)]">
                    ...
                    <div className="relative flex h-full w-full flex-col px-5 pb-8 pt-12">
                      ...
                      <div className="phone-widget relative mx-auto mb-8 flex size-44 items-center justify-center drop-shadow-[0_15px_25px_rgba(64,64,64,0.8)]">
