  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-full border border-[var(--color-border)] font-medium shadow-[2px_2px_0px_var(--color-shadow)] transition-all hover:translate-y-[2px] hover:shadow-none focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[var(--color-accent-primary)] focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        destructive:
          "bg-[var(--color-danger)] text-[var(--color-bg-card)] hover:bg-[var(--color-danger-hover)] focus-visible:ring-[var(--color-danger)]",
        outline:
