...
export default function MobileHeader() {
  ...
  return (
    <header className="fixed left-0 right-0 top-0 z-50 border-b border-[var(--color-glass-border)] bg-[var(--color-glass-bg)] backdrop-blur md:hidden">
      <div className="mx-auto flex min-h-[4rem] max-w-7xl items-center px-4 pr-16 pt-[env(safe-area-inset-top)]">
