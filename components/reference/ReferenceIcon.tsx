...
export const referenceIconShapes = {
...
export type ReferenceIconName = keyof typeof referenceIconShapes;
...
export function ReferenceIcon({
  ...
  return <FilledIcon shape={referenceIconShapes[name]} size={size} className={className} />;
}
