...
interface UnlockStatus {
  ...
  unlockMethod: "payment" | "referrals" | null;
  verifiedReferralCount: number;
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-[var(--color-text-secondary)] mt-1">
                    To prevent abuse and ensure platform quality, new accounts must either refer
                    verified users or pay a small unlock fee before withdrawing funds.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-3">
                ...
                >
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <div className="flex items-center justify-between mb-1">
                        <h4 className="font-bold">Pay ₦{unlockFee.toLocaleString()} Once</h4>
                        <span className="text-xs px-2 py-1 rounded-full bg-blue-500/20 text-blue-600 dark:text-blue-400 font-bold">
                          INSTANT
                        </span>
                      </div>
                      <p className="text-sm text-[var(--color-text-secondary)]">
                        One-time unlock fee. Withdraw immediately after payment.
                      </p>
                    </div>
                  </div>
                </button>
            ...
            {selectedMethod === "referrals" ? (
              ...
              <div className="p-4 rounded-lg bg-[var(--color-bg-secondary)]">
                ...
                <ul className="space-y-2 text-sm text-[var(--color-text-secondary)]">
                  ...
                  <li className="flex items-center gap-2">
                    <Me2uIcon name="check" size={16} className="text-green-500" />
                    <span>Instant unlock - withdraw immediately</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <Me2uIcon name="check" size={16} className="text-green-500" />
