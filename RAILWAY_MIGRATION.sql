-- ============================================================
-- Me2U Railway PostgreSQL Migration
-- Generated for Railway (non-Supabase) deployment
-- ============================================================

-- Create auth schema (Supabase compatibility layer)
CREATE SCHEMA IF NOT EXISTS auth;

-- Create auth.users table (minimal Supabase compatibility)
...
-- Create auth.uid() helper function (Supabase compatibility)
...
-- Create roles if they don't exist (Supabase compatibility)
DO $$
BEGIN
...
-- Now proceed with original migrations
-- ============================================================
