...
export default function KYCPage() {
  ...
  if (user.kycVerified) {
    return (
      <div className="app-mobile-screen mx-auto flex w-full max-w-lg flex-col items-center justify-center px-3.5 pt-[4.85rem] text-center md:py-24">
        <div className="mb-4 grid h-16 w-16 place-items-center rounded-[50px] border border-[var(--color-border)] bg-[var(--color-positive-bg)] text-[var(--color-positive-text)] shadow-[3px_3px_0px_var(--color-shadow)]">
  ...
  if (!user.registrationDepositPaid) {
    return (
      <div className="app-mobile-screen mx-auto w-full max-w-lg px-3.5 pt-[4.85rem] text-center md:pt-24">
        <div className="rounded-[50px] border border-[var(--color-border)] bg-[var(--color-bg-card)] p-6 shadow-[4px_4px_0px_var(--color-shadow)] md:p-8">
  ...
  return (
    <div className="app-mobile-screen mx-auto w-full max-w-lg px-3.5 pt-[4.85rem] md:pt-24">
      ...
      <div className="space-y-5 rounded-[50px] border border-[var(--color-border)] bg-[var(--color-bg-card)] p-6 shadow-[4px_4px_0px_var(--color-shadow)] md:space-y-8 md:p-8 kinetic-border">
        {error && (
          <div className="flex min-w-0 items-center gap-3 rounded-[50px] border border-[var(--color-border)] bg-[var(--color-negative-bg)] p-4.5 text-[var(--color-negative-text)]">
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              title="Bank Name"
              className="w-full rounded-[50px] border border-[var(--color-border)] bg-[var(--color-bg-secondary)] py-4 px-6 text-[var(--color-text-primary)] placeholder:text-[var(--color-text-secondary)] focus:border-[var(--color-accent-primary)] focus:outline-none focus:ring-1 focus:ring-[var(--color-accent-primary)] transition-all font-sans"
          ...
          <div>
            ...
            <input
              ...
              className="w-full rounded-[50px] border border-[var(--color-border)] bg-[var(--color-bg-secondary)] py-4 px-6 text-[var(--color-text-primary)] placeholder:text-[var(--color-text-secondary)] focus:border-[var(--color-accent-primary)] focus:outline-none focus:ring-1 focus:ring-[var(--color-accent-primary)] transition-all font-mono"
        ...
        <div className="space-y-4">
          ...
          <div className="relative">
            ...
            <label
              ...
              className="flex w-full cursor-pointer flex-col items-center justify-center gap-3 rounded-[50px] border-2 border-dashed border-[var(--color-border)] bg-[var(--color-bg-secondary)] py-8 px-6 transition-colors hover:border-[var(--color-accent-primary)]/50 hover:bg-[var(--color-bg-card)]"
            >
              {passportFile ? (
                <>
        ...
        <div className="space-y-4">
          ...
          <div className="flex min-w-0 items-center justify-between gap-3 rounded-[50px] border border-[var(--color-border)] bg-[var(--color-bg-secondary)] py-4.5 px-6 opacity-50">
            <div className="flex min-w-0 items-center gap-3">
              <div className="shrink-0 rounded-full bg-[var(--color-bg-card)] p-2">
            ...
            <span className="shrink-0 rounded-[50px] border border-[var(--color-border)] px-3 py-1 text-[10px] font-bold uppercase tracking-normal text-[var(--color-text-secondary)] sm:tracking-wider">
              Coming Soon
            </span>
          </div>
        </div>
