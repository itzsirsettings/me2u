...
const copyReplacements: ReadonlyArray<readonly [string, string]> = [
  ...
  [
    ...
    "Me2U turns account creation into a clear trust flow: registration deposit, payment proof, welcome bonus, KYC, and wallet access.",
  ],
  ...
  ["Access deals from partner merchants.", "0% interest loan from ₦5,000."],
  ...
  [
    ...
    "You create an account, pay the ₦1,000 registration deposit, upload proof, and activate your ₦2,000 welcome bonus after approval.",
  ],
  ...
  ["Embed the approved Me2U product demo video here.", "The live app flow starts with registration, deposit proof, welcome bonus, KYC, then wallet, marketplace, and loan actions."],
