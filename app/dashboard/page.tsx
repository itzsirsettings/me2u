...
const simpleShortcuts: Array<{
  ...
  { label: "Savings", path: "/savings", icon: "savings", tone: "bg-lime/20 text-lime" },
  { label: "Circles", path: "/circles", icon: "group", tone: "bg-green/20 text-green" },
  { label: "Deals", path: "/deals", icon: "deal", tone: "bg-slate text-snow" },
  { label: "Refer", path: "/referrals", icon: "referral", tone: "bg-lime/20 text-lime" },
  { label: "Learn", path: "/learn", icon: "book", tone: "bg-green/20 text-green" },
  { label: "Secure", path: "/security", icon: "security", tone: "bg-slate text-snow" },
];
        ...
        <div className="grid min-w-0 gap-2.5">
          <motion.section variants={itemVariants} className="mobile-soft-card relative min-w-0 overflow-hidden p-3">
            ...
            <div className="mb-3 flex items-center gap-1.5">
              ...
              >
                <Me2uIcon name={showBalance ? "visible" : "invisible"} size={20} />
              </button>
            </div>
            ...
            {simpleShortcuts.map((action, index) => (
              <button
                ...
                className={`flex min-h-[3.75rem] flex-col items-center justify-center gap-1 px-1 text-center transition active:scale-95 ${
                  index % 3 !== 0 ? "border-l border-[var(--color-border)]" : ""
                } ${index >= 3 ? "border-t border-[var(--color-border)]" : ""}`}
